            ...
            {isPopup && (
                <Fragment>
                    ...
                    <div className={cx("tmgPopupBox")}>
                        <div className={cx("tmgPopupText")}> Bạn có chắc chắn muốn xoá bàn {tableName}? </div>
                        <div className={cx("tmgPopupGroupButton")}>
                            <button className={cx("tmgCancelButton")} onClick={cancelHandle}>
                                Huỷ
                            </button>

                            <button className={cx("tmgDeleteTableButton")} onClick={confirmHandle}>
                                Xác Nhận
                            </button>
                        </div>
                    </div>
            ...
            {isSuccess &&
                <Fragment>
                    ...
                    <div className={cx("tmgSuccessBox")}>
                        <div className={cx("tmgPopupText")}>Xoá Bàn {tableName} Thành Công </div>
                        <div className={cx("tmgPopupGroupButton")}>
                            <button className={cx("tmgDeleteTableButton")} onClick={cancelHandle}>
                                Xác Nhận
                            </button>
                        </div>
                    </div>
                    ...
                    {tables.map((table, index) => (
                        <div className={cx("tmgItem")} key={index}>
                            <div className={cx("tmgLeftContainer")}>
                                ...
                                <div className={cx()}>
                                    Trạng Thái: {table.isActive ? "Đang hoạt động" : "Không Hoạt Động"}
                                </div>
                            </div>
                            <div className={cx("tmgRightContainer")}>
                                <button onClick={() => handleDeleteTable(table.name)}>Xoá Bàn</button>
                            </div>
                        </div>
                    ))}
                </div>
